...
describe("shortestPath", function() {
  it("should return the shortest path", function() {
    ...
    graph.addVertices([S, P, U, X, Q, Y, V, R, W, T, Z, K, L]);
    ...
    // expect(graph.shortestPath(T,Q).size).toEqual(3);
    // expect(graph.shortestPath(T,S).size).toEqual(5);
    // expect(graph.shortestPath(T,W).size).toEqual(2);
    expect(graph.shortestPath(T,Y).size).toEqual(3);
    // expect(graph.shortestPath(T,L).size).toEqual(8);
  });
});
